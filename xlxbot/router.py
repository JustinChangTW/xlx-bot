...
def build_prompt(state, user_input, knowledge_content, intent, manual_exists, manual_hit, lessons_guidance=None, history=None):
...
def build_route_prompt(state, route_label, user_input, knowledge_content, intent, manual_exists, manual_hit, lessons_guidance=None, history=None):
    route_note_map = {
    ...
    return build_prompt(state, user_input, routed_knowledge, intent, manual_exists, manual_hit, lessons_guidance, history)


def ask_ai(config, state, logger, providers, user_input, history=None, lessons_guidance=None):
    ...
    prompt = build_route_prompt(state, route_label, user_input, scoped_knowledge, intent, manual_exists, manual_hit, lessons_guidance, history)
